...
<a href='../Week/Graph.php'><button style='margin-top:5%;margin-left:35%;width:100px;height:30px;font-size:100%;'>週期模式</button></a>
...
<!------------------------------------日期選擇--------------------------->
	...
	<div class="div1">
	<p style="font-size:30px;">請選擇日期:</p>
	</div>
	<div class="div1">
	<input type="date" name="Day" style='width:150px;height:30px;font-size:20px;' value="<?php if(!empty($_POST['Day'])){echo $_POST['Day'];}else if(!empty($Final_Day)){echo $Final_Day;}else{date('Y-m-d');}?>" min="<?php if(!empty($Inital_Day)){echo $Inital_Day;}else{date('Y-m-d');}?>" max="<?php if(!empty($Final_Day)){echo $Final_Day;}else{date('Y-m-d');}?>" size="50">
	</div>
