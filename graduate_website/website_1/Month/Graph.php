...
#if(!empty($_SESSION['pre_ID']) and !empty($_SESSION['pre_Month']) and !empty($_SESSION['pre_Condition']) and !empty($_SESSION['pre_Class'])){
#	$_POST['ID']=$_SESSION['pre_ID'];
#	$_POST['Day']=$_SESSION['pre_Month'];
...
<body>
	...
	<p>機台ID:<?php echo $_POST['ID'];?><br>目前月份:<?php echo $_POST['Month'];?><br></p>
	<div class="nav">
	...
	<div style="margin-top:100px;" class="bar-block_1">
	  <div class="container_1">
			...
			<center><table  style="border:5px #1b21de solid;padding:10px;font-size:25px" rules="all" cellpadding='5';>
					...
					<?php $i=0; foreach($conditions as $key => $value){echo '<tr> <td>' . $value['Day'] . '</td>' . '<td>' . $value['moisture']. '</td> <td>' . $location_tempature[$i]['Tempature'] . '</td> </tr>'; $i++;}?>
			</table></center>
			...
			<?php if($_POST['Class']=='All')
			 ...
			 <h5>類別表格</h5>
				 <center><table  style="border:5px #1b21de solid;padding:10px;font-size:25px" rules="all" cellpadding='5';>
					...
					<?php foreach($conditions as $key => $value){echo '<tr> <td>' . $value['Day'] . '</td> <td>' . $value['TomatoWorm'] .
'</td><td>' . $value['TabaccoWorm'] . '</td> <td>' . $value['BeetWorm']. '</td> <td>' . $value['Problems'] . '</td> <td>' . $value['None'] . '</td> <td>' . $value['Tomato'] . '</td> <td>' . $value['TomatoFlower'] 	. '</td> </tr>';}?>
			...
			<?php } 
					...
					<?php foreach($conditions as $key => $value){echo '<tr> <td>' . $value['Day'] . '</td>' . '<td>' . $value['TomatoWorm'] . '</td> </tr>';}?>
					</table></center>
			...
			<?php } 
					...
					<?php foreach($conditions as $key => $value){echo '<tr> <td>' . $value['Day'] . '</td>' . '<td>' . $value['TabaccoWorm'] . '</td> </tr>';}?>
					</table></center>
					<div style="margin-top:100px;">
			...
			<?php } 
					...
					<?php foreach($conditions as $key => $value){echo '<tr> <td>' . $value['Day'] . '</td>' . '<td>' . $value['BeetWorm'] . '</td> </tr>';}?>
					</table></center>
					<div style="margin-top:100px;">
			...
			<?php } 
					...
					<?php foreach($conditions as $key => $value){echo '<tr> <td>' . $value['Day'] . '</td>' . '<td>' . $value['Problems'] . '</td> </tr>';}?>
					</table></center>
					<div style="margin-top:100px;">
			...
			<?php } 
					...
					<?php foreach($conditions as $key => $value){echo '<tr> <td>' . $value['Day'] . '</td>' . '<td>' . $value['None'] . '</td> </tr>';}?>
					</table></center>
					<div style="margin-top:100px;">
			...
			<?php } 
					...
					<?php foreach($conditions as $key => $value){echo '<tr> <td>' . $value['Day'] . '</td>' . '<td>' . $value['Tomato'] . '</td> </tr>';}?>
					</table></center>
					<div style="margin-top:100px;">
			...
			<?php } 
					...
					<?php foreach($conditions as $key => $value){echo '<tr> <td>' . $value['Day'] . '</td>' . '<td>' . $value['TomatoFlower'] . '</td> </tr>';}?>
					</table></center>
					<div style="margin-top:100px;">
...
<script>
	...
	{?>
	labels.push('<?php echo  $value['Day'];?>')
	<?php
	;}
	?>
...
<script>
	...
	?>
    var data = [<?php foreach($location_tempature as $key => $value){foreach($conditions as $key => $value_1){if($value['Day']==$value_1['Day']){echo  $value['Tempature'] . ',';}}}?>];
